<<<<<<< HEAD:Components/Header/NavBar/navBar.php
<?php
session_start();
?>
...
<body>
  ...
  <header class="header" data-header>
    <div class="container">
      <a href="../../../index.html" target="_top" class="logo">
        <img src="../../Images/Captura de tela 2024-06-06 164451.png" width="50" height="38" alt="SEF home">
      </a>
      <nav class="navbar" data-navbar>
        <button class="nav-close-btn" aria-label="close menu" data-nav-toggler>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="../../../Components/RestaurantesBusca/restaurantsPage.html" target="_top" class="navbar-link" data-nav-link>Restaurantes</a>
          </li>
          <li class="navbar-item"> 
            <a href="../../../Components/RestaurantLogin/RestaurantLogin.html" target="_top" class="navbar-link" data-nav-link>Login Restaurante</a>
          </li>
          ...
          <li class="navbar-item">
            <a href="../../../Components/admLogin/adminLogin.html" target="_top"  class="navbar-link" data-nav-link>Login Gerente</a>
          </li>
        </ul>
      </nav>
      <div class="header-action">
...
>>>>>>> 6e5ee07e1b8aa75beada922ac4604f766a6a2529:Components/Header/NavBar/navBar.html
