    ...
    function addProductToCart(event) {
        ...
        for (let i = 0; i < productsCartNames.length; i++) {
            if (productsCartNames[i].innerText === productName) {
                productsCartNames[i].parentElement.parentElement.getElementsByClassName("add-product-button")[0].value++;
                updateTotal();
                return;
            }
        }
        ...
        <td>
            <input type="number" value="1" min="0" class="add-product-button">
    ...
    function updateTotal() {
        ...
        document.querySelector(".carrinho-totalr span").innerText = "R$" + totalAmount;
    }
