        ...
        <nav class="navbar">
            ...
            if (!isset($_SESSION['login']) || $_SESSION['login'] !== true) {
                ...
                if ($_SESSION['tipo'] == 'cliente') {
                    ...
                    echo '<a href="/Sem-Esperar-em-Filas/Components/EditarPerfil/EditPerfil.php" class="user-icon" data-tooltip="Olá, ' . htmlspecialchars($cliente) . '">
                ...
                // Se o usuário estiver logado como restaurante
                    ...
                    <a href="/Sem-Esperar-em-Filas/Components/EditarPerfil/EditPerfil.php" class="user-icon" data-tooltip="Olá, ' . htmlspecialchars($restaurante) . '">
