        ...
        <nav class="navbar">
            ...
            if (!isset($_SESSION['login']) || $_SESSION['login'] !== true) {
                ...
                // Se o usuário estiver logado como restaurante
                    ...
                    <a href="/Sem-Esperar-em-Filas/Components/EditarPerfil/EditPerfil.php" class="user-icon" data-tooltip="Olá, ' . htmlspecialchars($restaurante) . '"><i class="fas fa-user"></i> </a>';
                }
